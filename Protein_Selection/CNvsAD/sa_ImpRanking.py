...
outfile = dpath + 'Results/CNvsAD/sa_Importance.csv'
mydf = pd.read_csv(dpath + 'Data/ADNI_CSF_DATA.csv')
auc_df = pd.read_csv(dpath + 'Results/CNvsAD/s0.1_AUC_direct.csv', usecols=['Analytes', 'AUC_BT_median', 'AUC_BT_out'])
dict_df = pd.read_csv(dpath + 'Data/ADNI_CSF_DICT.csv', usecols = ['Analytes', 'Target', 'EntrezGeneSymbol', 'TargetFullName'])
my_f_df = pd.read_csv(dpath + 'Data/CNvsAD_Association.csv')
