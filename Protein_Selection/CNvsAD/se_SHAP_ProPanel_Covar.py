...
outimg = dpath + 'Results/CNvsAD/sh_SHAP_ProPanel_Covar.png'
pro_auc_df = pd.read_csv(dpath + 'Results/CNvsAD/sd_SFS.csv')
...
mydf = pd.read_csv(dpath + 'Data/ADNI_CSF_DATA.csv', usecols=['RID', 'DX1'])
...
ax = plt.gca()
ax.set_ylabel('ProteinPanel + demographic info', fontsize = 18, weight = 'bold')
